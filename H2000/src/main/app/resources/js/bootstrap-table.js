...
(function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        this.$header.find('th[data-field]').each(function (i) {
            ...
            if(typeof columns[0][i].headerCellTpl=="function"){
                $(this).find(".th-inner").append(columns[0][i].headerCellTpl());
            }
           /* if(typeof columns[i].headerCellTpl=="function"){
                $(this).find(".th-inner").append(columns[i].headerCellTpl());
            }*/
        });
    ...
    BootstrapTable.prototype.refresh = function (params,callback) {
